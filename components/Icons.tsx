...
export const UtensilsIcon: React.FC<IconProps> = ({ size = 20, className = "", ...props }) => (
  ...
  >
    ...
    <path d="M15 2v14" />
    <path d="M15 20v2" />
    <path d="M6 2v12a3 3 0 0 0 3 3 3 3 0 0 0 3-3V2" />
    <path d="M9 17v5" />
  </svg>
);
...
export const BellRingIcon: React.FC<IconProps> = ({ size = 20, className = "", ...props }) => (
  <svg
    width={size}
    height={size}
    viewBox="0 0 24 24"
...
export const QrScanIcon: React.FC<IconProps> = ({ size = 18, className = "", ...props }) => (
  <svg
    width={size}
    height={size}
    viewBox="0 0 24 24"
...
export const TableIcon: React.FC<IconProps> = ({ size = 20, className = "", ...props }) => (
  <svg
    width={size}
    height={size}
    viewBox="0 0 24 24"
...
export const RotateCcwIcon: React.FC<IconProps> = ({ size = 20, className = "", ...props }) => (
  <svg
    width={size}
    height={size}
    viewBox="0 0 24 24"
...
export const WalletIcon: React.FC<IconProps> = ({ size = 18, className = "", ...props }) => (
  <svg
    width={size}
    height={size}
    viewBox="0 0 24 24"
...
export const PhoneDownloadIcon: React.FC<IconProps> = ({ size = 22, className = "", ...props }) => (
  <svg
    width={size}
    height={size}
    viewBox="0 0 24 24"
...
export const CopyIcon: React.FC<IconProps> = ({ size = 14, className = "", ...props }) => (
  <svg
    width={size}
    height={size}
    viewBox="0 0 24 24"
